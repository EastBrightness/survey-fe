        ...
        <Paper elevation={3} sx={{ p: 6 }}>
          ...
          {!currentEvaluation && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              {employeeData?.selfYn && !employeeData?.completedSelf && (
                <Button
                  variant="contained"
                  color="primary"
                  fullWidth
              ...
              {employeeData?.othersTester && !employeeData?.completedOthers && (
                <Box sx={{ mt: 4 }}>
      ...
      {tested.isCompleted ? (
        ...
        >
          평가 실시하기
              ...
              {(employeeData?.completedSelf && employeeData?.completedOthers) && (
                <Typography color="textSecondary">
                  이미 참여 완료한 대상자입니다.
                </Typography>
              )}
